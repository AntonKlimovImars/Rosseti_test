...
@if($style === 'card_blue')
    <div class="rounded-2xl bg-[#1B2733] p-8 flex flex-col justify-between min-h-[200px]">
...
@elseif($style === 'card_light')
    <div class="rounded-2xl bg-[#F7F9FC] border border-[#E1E7F0] p-8 flex flex-col justify-between min-h-[200px]">
        ...
        @endif
        <div>
            <p class="text-5xl font-bold text-[#005B9C] mb-2">{{ $data['value'] }}</p>
...
@elseif($style === 'inline_large')
    <div class="text-center py-8">
        <p class="text-6xl font-bold text-[#005B9C] mb-3">{{ $data['value'] }}</p>
...
@elseif($style === 'inline_left')
    <div class="flex items-center gap-8 py-4 lg:flex-col lg:items-start">
        <p class="text-5xl font-bold text-[#005B9C] shrink-0">{{ $data['value'] }}</p>
        <div>
...
@elseif($style === 'accent_border')
    <div class="border-l-4 border-[#005B9C] pl-6 py-4">
        <p class="text-4xl font-bold text-[#005B9C] mb-2">{{ $data['value'] }}</p>
